...
public class Constants {
    ...
    public static final String TITLE = "PrestaFind";
    public static final Double MIN_WIDTH = 1040.00;
    public static final Double MIN_HEIGHT = 640.00;

    public static final String SOURCE_PACKAGES = "/tn/prestafind";
    public static final String MEDIA_PACKAGE = SOURCE_PACKAGES + "/resources/media/";
    public static final String VIEWS_PACKAGE = SOURCE_PACKAGES + "/gui/views/";
    ...
    public static final String TEST_VIEW = VIEWS_PACKAGE + "test.fxml";
    public static final String LOGIN_VIEW = VIEWS_PACKAGE + "LoginView.fxml";
    public static final String BLOG_VIEW = VIEWS_PACKAGE + "blog.fxml";
    public static final String POST_VIEW = VIEWS_PACKAGE + "post.fxml";
    ...
    public static final String LOGO = MEDIA_PACKAGE + "logo.png";
