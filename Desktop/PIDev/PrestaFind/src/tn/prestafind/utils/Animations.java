...
public class Animations {
    ...
    public static void transition(Pane firstPane, Pane secondPane) {
        // create a fade transition to fade out the first pane
        FadeTransition fadeOut = new FadeTransition(Duration.seconds(1), firstPane);
        fadeOut.setToValue(0);

        // create a translate transition to move the second pane into view
        TranslateTransition translateIn = new TranslateTransition(Duration.seconds(1), secondPane);
        translateIn.setFromX(secondPane.getWidth());
        translateIn.setToX(0);

        // create a fade transition to fade in the second pane
        FadeTransition fadeIn = new FadeTransition(Duration.seconds(1), secondPane);
        fadeIn.setToValue(1);

        // play the fade and translate transitions in sequence
