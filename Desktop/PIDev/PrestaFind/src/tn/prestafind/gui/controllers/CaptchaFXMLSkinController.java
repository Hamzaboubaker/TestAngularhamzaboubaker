...
import tn.prestafind.utils.Captcha;
...
public class CaptchaFXMLSkinController extends VBox implements Skin<Captcha> {
    ...
    public CaptchaFXMLSkinController(Captcha control) {
